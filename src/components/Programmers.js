...
export default function Programmers() {
  ...
  const getNameOfFeatured = () => {
    ...
    //console.log("id in getNameOfFeatured: ", programmers[id-1].name)
  ...
  const style = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: id != false ? 'gold' : 'royalblue', // 🤔 color turns to gold, when celebrating
  };
      ...
      <div className='programmers'>
        {
          ...
          listOfAwesome.map(dev =>
            <div className='programmer' key={dev.id}>
              {console.log("dev: ", dev, " dev.id: ", dev.id)}
